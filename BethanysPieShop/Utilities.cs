     ...
     internal class Utilities
    {
        ...
        internal static void InitializeStock()//Mock implementation
        {
            ...
            */
            ...
            bp.ToString();
            bp.ConvertProductPrice(Currency.Pound);
        ...
        {
            Console.WriteLine($"Enter the new stock treshold (current value: {Product.StockThresold}). This applies to all products!");
            Console.Write("New value: ");
            int newValue = int.Parse(Console.ReadLine() ?? "0");
            Product.StockThresold = newValue;
            Console.WriteLine($"New stock treshold set to {Product.StockThresold}");
